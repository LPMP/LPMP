...
namespace LPMP {
    ...
    class sequence_compression {
        public:
            ...
            bool index_added(const std::size_t index) const;
    ...
    void sequence_compression::reset()
    {
    ...
    std::size_t sequence_compression::add_index(const std::size_t index)
    {
    ...
    bool sequence_compression::index_added(const std::size_t index) const
    {
        assert(index < orig_to_compressed_index_.size());
        return orig_to_compressed_index_[index] != index_not_present;
    }

    std::size_t sequence_compression::orig_to_compressed_index(const std::size_t orig_index) const
    {
    ...
    std::size_t sequence_compression::compressed_to_orig_index(const std::size_t compressed_index) const
    {
