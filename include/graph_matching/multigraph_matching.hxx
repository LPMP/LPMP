...
struct FMC_MGM_T { // factor message connection with tightening triplets for underlying MRFs
   ...
   using empty_mrf_triplet_factor = FactorContainer<SimpleTighteningTernarySimplexFactor, FMC_MGM_T, 3>;

   using FactorList = meta::list< UnaryFactor, PairwiseFactor, triplet_consistency_factor, empty_mrf_triplet_factor >;
   ...
   using pairwise_triplet_12_message = MessageContainer<PairwiseTripletMessage<0,1>, 1, 3, message_passing_schedule::left, variableMessageNumber, 1, FMC_MGM_T, 6>;
   using pairwise_triplet_13_message = MessageContainer<PairwiseTripletMessage<0,2>, 1, 3, message_passing_schedule::left, variableMessageNumber, 1, FMC_MGM_T, 7>;
   using pairwise_triplet_23_message = MessageContainer<PairwiseTripletMessage<1,2>, 1, 3, message_passing_schedule::left, variableMessageNumber, 1, FMC_MGM_T, 8>; 
