...
int main(int argc, char** argv)
{
    ...
    // qpbo, nonsubmodular, but tight
    {
        ...
        test(input.arcs.size() == 11); 

        test(input.arcs[0][0] == 0 && input.arcs[0][1] == 2 && input.arcs[0].capacity == 2);
        test(input.arcs[1][0] == 0 && input.arcs[1][1] == 6 && input.arcs[1].capacity == 3);
        test(input.arcs[2][0] == 4 && input.arcs[2][1] == 1 && input.arcs[2].capacity == 4);
        test(input.arcs[3][0] == 2 && input.arcs[3][1] == 4 && input.arcs[3].capacity == 3);
        test(input.arcs[4][0] == 4 && input.arcs[4][1] == 2 && input.arcs[4].capacity == 3);
        test(input.arcs[5][0] == 3 && input.arcs[5][1] == 5 && input.arcs[5].capacity == 3);
        test(input.arcs[6][0] == 5 && input.arcs[6][1] == 3 && input.arcs[6].capacity == 3);
        test(input.arcs[7][0] == 4 && input.arcs[7][1] == 7 && input.arcs[7].capacity == 3);
        test(input.arcs[8][0] == 7 && input.arcs[8][1] == 4 && input.arcs[8].capacity == 3);
        test(input.arcs[9][0] == 5 && input.arcs[9][1] == 6 && input.arcs[9].capacity == 3);
        test(input.arcs[10][0] == 6 && input.arcs[10][1] == 5 && input.arcs[10].capacity == 3);
