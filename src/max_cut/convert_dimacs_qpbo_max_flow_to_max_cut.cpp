...
int main(int argc, char** argv)
{
    ...
    const auto binary_MRF_input = transform_QPBO_max_flow_to_binary_MRF(max_flow_input);
    const auto binary_Potts_input = transform_binary_MRF_to_Potts(binary_MRF_input);
